...
- (void) updateClock:(NSTimer *)theTimer
{
    ...
    [currentCalendar setTimeZone:[NSTimeZone timeZoneWithName:selectedTimeZone]];
    NSDateComponents *dateComponents = [currentCalendar components:(NSHourCalendarUnit | NSMinuteCalendarUnit | NSSecondCalendarUnit) fromDate:[NSDate date]];
